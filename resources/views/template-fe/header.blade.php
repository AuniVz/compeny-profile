                ...
                <div class="outer-box clearfix">
                    <div class="logo-box pull-left">
                        <figure class="logo"><a href="index.html"><img
                                    src="{{ asset('template-fe/assets/images/logo.png') }}" alt=""></a>
                        </figure>
                    </div>
                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-3 column">
                                                    <ul>
                                                        ...
                                                        <li><a href="testimonial-element-1.html">Testimonial 01</a>
                                                        </li>
                                                        <li><a href="testimonial-element-2.html">Testimonial 02</a>
                                                        </li>
                                                        <li><a href="testimonial-element-3.html">Testimonial 03</a>
                                                        </li>
        ...
        <div class="sticky-header">
            <div class="auto-container">
                <div class="outer-box clearfix">
                    <div class="logo-box pull-left">
                        <figure class="logo"><a href="index.html"><img
                                    src="{{ asset('template-fe/assets/images/small-logo.png') }}" alt=""></a>
                        </figure>
                    </div>
                    <div class="menu-area pull-right">
