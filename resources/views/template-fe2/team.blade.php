        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="team">
                        <div class="team-image"> <img src="{{ asset('tempalet-fe2/images/team01.png') }}">
                            <div class="team-info">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="team">
                        <div class="team-image"> <img src="{{ asset('tempalet-fe2/images/team02.png') }}">
                            <div class="team-info">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="team">
                        <div class="team-image"> <img src="{{ asset('tempalet-fe2/images/team03.png') }}">
                            <div class="team-info">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="team">
                        <div class="team-image"> <img src="{{ asset('tempalet-fe2/images/team04.png') }}">
                            <div class="team-info">
