...
@section('content')
        ...
        <div class="banner-carousel owl-theme owl-carousel owl-dots-none">
            <div class="slide-item">
                <div class="image-layer"
                    style="background-image: url('{{ asset('template-fe/assets/images/banner/banner-1.jpg') }}');">
                </div>
                <div class="auto-container">
                    <div class="content-box">
                        ...
                        <div class="btn-box">
                            ...
                            <a href="index-6.html" class="user-btn"><i class="far fa-user"></i><span>Find a
                                    Consultant</span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="slide-item">
                <div class="image-layer"
                    style="background-image: url('{{ asset('template-fe/assets/images/banner/banner-2.jpg') }}');"></div>
                <div class="auto-container">
            ...
            <div class="slide-item">
                <div class="image-layer"
                    style="background-image: url('{{ asset('template-fe/assets/images/banner/banner-3.jpg') }}');"></div>
                <div class="auto-container">
                    <div class="content-box">
                        <h5>get on the right way</h5>
            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 video-column">
                    <div class="video-inner">
                        <figure class="image-box"><img src="assets/images/resource/about-1.jpg" alt="">
                        </figure>
                        <div class="video-btn">
                        ...
                        <div class="service-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                            ...
                            <div class="inner-box">
                                ...
                                <div class="inner">
                                    ...
                                    <a href="planning-strategies.html"><i class="fas fa-arrow-right"></i><span>Read
                                            More</span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="service-block-one wow fadeInUp animated animated" data-wow-delay="300ms"
                            ...
                            <div class="inner-box">
                                ...
                                <div class="inner">
                                    ...
                                    <p>Acepteur sintas haecat sed non dui proident sunt culpa sed ipsum tempor.</p>
                                    <a href="financial-analysis.html"><i class="fas fa-arrow-right"></i><span>Read
                                            More</span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="service-block-one wow fadeInUp animated animated" data-wow-delay="600ms"
                            ...
                            <div class="inner-box">
                                ...
                                <div class="inner">
                                    ...
                                    <p>Acepteur sintas haecat sed non dui proident sunt culpa sed ipsum tempor.</p>
                                    <a href="investment-trading.html"><i class="fas fa-arrow-right"></i><span>Read
                                            More</span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="service-block-one wow fadeInUp animated animated" data-wow-delay="300ms"
                            ...
                            <div class="inner-box">
                                ...
                                <div class="inner">
                                    ...
                                    <p>Acepteur sintas haecat sed non dui proident sunt culpa sed ipsum tempor.</p>
                                    <a href="wealth-marketing.html"><i class="fas fa-arrow-right"></i><span>Read
                                            More</span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="service-block-one wow fadeInUp animated animated" data-wow-delay="600ms"
                            ...
                            <div class="inner-box">
                                ...
                                <div class="inner">
                                    ...
                                    <p>Acepteur sintas haecat sed non dui proident sunt culpa sed ipsum tempor.</p>
                                    <a href="taxation-planning.html"><i class="fas fa-arrow-right"></i><span>Read
                                            More</span></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="fluid-container">
            <div class="project-carousel theme-carousel owl-theme owl-carousel owl-dots-none owl-nav-none">
                <div class="project-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="assets/images/gallery/project-1.jpg" alt="">
                        </figure>
                        <div class="lower-content">
                ...
                <div class="project-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="assets/images/gallery/project-2.jpg" alt="">
                        </figure>
                        <div class="lower-content">
                ...
                <div class="project-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img src="assets/images/gallery/project-3.jpg" alt="">
                        </figure>
                        <div class="lower-content">
                            <p>Corporate Management</p>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div id="image_block_one">
                        <div class="image-box">
                            <div class="pattern-layer" style="background-image: url(assets/images/shape/shape-1.png);">
                            </div>
                            <figure class="image"><img src="assets/images/resource/state-1.jpg" alt="">
                            </figure>
                            <div class="award-box">
                                <div class="box">
                                    <figure class="icon-box"><img src="assets/images/icons/icon-1.png" alt="">
                                    </figure>
                ...
                <div class="location-area">
                    <div class="location-box">
                        <div class="address-box">
                            <figure class="icon-box"><img src="assets/images/icons/icon-2.png" alt="">
                            </figure>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 info-column">
                        <div class="info-inner">
                            <figure class="image-box"><img src="assets/images/resource/info-1.jpg" alt="">
                            </figure>
                            <div class="info-box">
                                <figure class="info-logo"><img src="assets/images/icons/info-logo.png" alt="">
                                </figure>
            ...
            <div class="testimonial-inner">
                ...
                <div class="client-thumb-outer">
                    <div class="client-thumbs-carousel owl-carousel owl-theme owl-nav-none owl-dots-none">
                        ...
                        <div class="thumb-item">
                            <figure class="thumb-box"><img src="assets/images/resource/testimonial-3.png" alt="">
                            </figure>
                            <div class="info-box">
                                <h5>Jhon Doe</h5>
                                <span class="designation">Senior Manager</span>
                        ...
                        <div class="thumb-item">
                            <figure class="thumb-box"><img src="assets/images/resource/testimonial-4.png" alt="">
                            </figure>
                            <div class="info-box">
                                <h5>Robert</h5>
                                <span class="designation">Senior Manager</span>
                        ...
                        <div class="thumb-item">
                            <figure class="thumb-box"><img src="assets/images/resource/testimonial-5.png" alt="">
                            </figure>
                            <div class="info-box">
                                <h5>Tomas Tom</h5>
                                <span class="designation">Senior Manager</span>
    ...
    <div style="height: 200vh">
        <img src="{{ asset('tempate-fe/assets/images/banner/banner-1.jpg') }}" alt="logo">
    </div>
    {{-- end testing --}}
@endsection
